			...
			children: [
				{
					id: 81,
					path: "map-demo",
					component: "test/canvas/MapDemo",
					name: "message.menu.testMap",
					title: "message.title.testMap",
					icon: "icon-appstore",
					isLink: false,
					isIframe: false,
					address: "",
				...
				},
				{
					id: 82,
					path: "map-one",
					component: "test/canvas/MapOne",
					name: "message.menu.testMapOne",
					title: "message.title.testMapOne",
					icon: "icon-appstore",
					isLink: false,
					isIframe: false,
					address: "",
				...
				},
				{
					id: 83,
					path: "map-two",
					component: "test/canvas/MapTwo",
					name: "message.menu.testMapTwo",
					title: "message.title.testMapTwo",
					icon: "icon-appstore",
					isLink: false,
					isIframe: false,
					address: "",
